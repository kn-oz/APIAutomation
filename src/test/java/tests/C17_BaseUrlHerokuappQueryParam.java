...
public class C17_BaseUrlHerokuappQueryParam extends HerokuAppBaseUrl {
    ...
    */
     ...
     */
        ...
        response.then().assertThat()
                .statusCode(200).body("bookingid", Matchers.hasItem(1288));
    ...
    */
       ...
       // response.then().assertThat().statusCode(200).body("firstname",Matchers.hasToString("Jim")).body("lastname",Matchers.hasToString("Jackson"));
